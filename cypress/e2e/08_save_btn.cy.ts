...
describe("studio", () => {
    ...
    it("save btn test", () => {
      ...
      cy.readFile(`${Cypress.config('downloadsFolder')}/flojoy.txt`).then((downloadedFile)=>{
        cy.readFile(`${Cypress.config('downloadsFolder')}/flojoyCompare.txt`).then((originalFile)=>{
