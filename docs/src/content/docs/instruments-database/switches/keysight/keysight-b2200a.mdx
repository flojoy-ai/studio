---
title: Connecting to Keysight B 220 X by Keysight in Python
...
![Keysight B 220 X](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782582/Instruments/Switch/Keysight-B2200A/Keysight-B2200A.png)
...
## Connect to the Keysight B 220 X in Python
