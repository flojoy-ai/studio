---
title: Connecting to AFG 3152 C by Tektronix in Python
...
![AFG 3152 C](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782664/Instruments/Function%20Generators/AFG3152C/AFG3152C.jpg)
...
## Connect to the AFG 3152 C in Python
