---
title: Connecting to Ats_base by Temptronic in Python
...
![Ats_base](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782446/Instruments/Temperature%20Controllers/Thermostream-ATS-Series/Thermostream-ATS-Series.webp)
...
## Connect to the Ats_base in Python
