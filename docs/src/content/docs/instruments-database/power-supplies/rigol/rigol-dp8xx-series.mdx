---
title: Connecting to Private by Rigol in Python
...
![Private](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782754/Instruments/Power%20Supplies/Rigol-DP8xx-Series/Rigol-DP8xx-Series.jpg)
...
## Connect to the Private in Python
