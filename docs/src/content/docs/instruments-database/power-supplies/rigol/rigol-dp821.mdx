---
title: Connecting to DP 821 by Rigol in Python
...
![DP 821](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782634/Instruments/Power%20Supplies/Rigol-DP821/Rigol-DP821.jpg)
...
## Connect to the DP 821 in Python
