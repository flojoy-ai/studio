---
title: Connecting to Keithley 2611 B by Keithley in Python
...
image: https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782565/Instruments/Power%20Supplies/Keithley-2611B/Keithley-2611B.webp
sidebar:
    label: Keithley 2611 B 
---
...
![Keithley 2611 B](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782565/Instruments/Power%20Supplies/Keithley-2611B/Keithley-2611B.webp)

Device Specification: [here](https://download.tek.com/manual/SPEC-2612B_B_Feb_2014.pdf)
...
## Connect to the Keithley 2611 B in Python
