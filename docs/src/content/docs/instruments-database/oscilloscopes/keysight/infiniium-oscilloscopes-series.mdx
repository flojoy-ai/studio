---
title: Connecting to Infiniium by Keysight in Python
...
![Infiniium](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782509/Instruments/Oscilloscopes/Infiniium-oscilloscopes-Series/Infiniium-oscilloscopes-Series.jpg)
...
## Connect to the Infiniium in Python
