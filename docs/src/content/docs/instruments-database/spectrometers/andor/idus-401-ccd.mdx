---
title: Connecting to DU 401 by Andor in Python
...
![DU 401](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782711/Instruments/Spectrometers/IDUS-401-CCD/IDUS-401-CCD.png)
...
## Connect to the DU 401 in Python
