...
<FeaturedInstrumentVideo
  category="QUANTUM_COMPUTING_CONTROL_SYSTEMS"
...
<NodeCardCollection category="QUANTUM_COMPUTING_CONTROL_SYSTEMS" manufacturer="Zurich Instruments"></NodeCardCollection>
