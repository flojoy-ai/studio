---
title: Connecting to SP 983 C by Basel in Python
...
![SP 983 C](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782441/Instruments/IV%20Converter/SP983c/SP983c.webp)
...
<FeaturedInstrumentVideo
  category="IV_CONVERTERS"
  manufacturer="BASEL"
></FeaturedInstrumentVideo>

## Connect to the SP 983 C in Python
