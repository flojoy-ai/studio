---
title: Connecting to Ibeamsmart by Toptica in Python
...
![Ibeamsmart](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782611/Instruments/Lasers/iBeam-smart/iBeam-smart.jpg)
...
## Connect to the Ibeamsmart in Python
