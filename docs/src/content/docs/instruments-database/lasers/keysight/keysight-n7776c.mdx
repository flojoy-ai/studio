---
title: Connecting to Keysightn 7776 C by Keysight in Python
...
![Keysightn 7776 C](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782473/Instruments/Lasers/Keysight-N7776C/Keysight-N7776C.png)
...
## Connect to the Keysightn 7776 C in Python
