...
image: https://res.cloudinary.com/dhopxs1y3/image/upload/v1692639436/Instruments/Protocols/SCPI-Instrument/file.png
sidebar:
...
![SCPI Instrument](https://res.cloudinary.com/dhopxs1y3/image/upload/v1692639436/Instruments/Protocols/SCPI-Instrument/file.png)
...
<SectionsCard category="PROTOCOLS" manufacturer="Generic SCPI"></SectionsCard>
