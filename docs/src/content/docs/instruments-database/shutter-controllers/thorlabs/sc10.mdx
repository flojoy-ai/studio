---
title: Connecting to SC 10 by Thorlabs in Python
...
![SC 10](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782726/Instruments/Shutter%20Controller/SC10/SC10.jpg)
...
## Connect to the SC 10 in Python
