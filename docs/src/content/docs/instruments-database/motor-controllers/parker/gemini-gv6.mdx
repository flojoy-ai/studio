---
title: Connecting to Parkergv 6 by Parker in Python
...
![Parkergv 6](https://res.cloudinary.com/dhopxs1y3/image/upload/v1691782707/Instruments/Servo%20Drive/Controllers/Gemini-GV6/Gemini-GV6.jpg)
...
## Connect to the Parkergv 6 in Python
