...
You can also [request](https://toqo276pj36.typeform.com/to/F5rSHVu1) a custom Block that the team will create for you. For faster response time with creating Blocks (or other techincal issues), please contact us using our [Discord Server](https://discord.gg/dPCrKxZR).
...
<BlockCategory blocks={[{'link': '/blocks/hardware/oscilloscopes/tektronix/mso2x/connect-mso2x', 'name': 'CONNECT_MSO2X', 'description': 'Open a VISA connection to an MSO2X Tektronix oscilloscope.'}, {'link': '/blocks/hardware/function-generators/tektronix/afg31000/connect-afg31000', 'name': 'CONNECT_AFG31000', 'description': 'Connect Flojoy to a AFG31000 function generator.'}, {'link': '/blocks/hardware/sourcemeters/keithley/2450/connect-2450', 'name': 'CONNECT_2450', 'description': 'Open a VISA connection to an Keithley 2450 SourceMeter.'}, {'link': '/blocks/hardware/multimeters/keithley/dmm7510/connect-dmm7510', 'name': 'CONNECT_DMM7510', 'description': 'Open a VISA connection to a Keithley DMM7510.'}, {'link': '/blocks/hardware/oscilloscopes/tektronix/mdo3xxx/connection-mdo3xxx', 'name': 'CONNECTION_MDO3XXX', 'description': 'Connect Flojoy to a MDO3XXX oscilloscope.'}, {'link': '/blocks/hardware/signal-analyzers/tektronix/rsa500/extract-spectrum-rsa500', 'name': 'EXTRACT_SPECTRUM_RSA500', 'description': 'Extracts and returns the spectrum trace from an Tektronix RSA.'}]} />
