...
from captain.precompilation.templates.functions.remove_missing_pip_packages import remove_missing_pip_packages
...
class FlojoyScriptBuilder:
    ...
    def import_app_nodes(self, graph_nodes):
        ...
        # helper function to minify python file
        def minify_python_file(from_path, to_path):
            with open(from_path, "r") as f:
                file_str = f.read()
            file_str = python_minifier.minify(file_str)
        ...
        def copy_file_to_output_dir(path):
            ...
            if os.path.isfile(path):
                minify_python_file(path, output_path)
            else:
            ...
            while len(stack) > 0:
                ...
                for node in ast.walk(cur_module):
                    ...
                    # handle relative import 
                        ...
                        path = os.path.join(path, module_name.replace(".", os.path.sep) + ".py")
