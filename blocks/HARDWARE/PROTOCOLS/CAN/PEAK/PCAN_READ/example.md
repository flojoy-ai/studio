In this example, we utilize the `PCAN_READ` block to decipher CAN bus messages received from a CAN bus sniffer (PEAK Can USB) and present the output in a tabular format.
