In this example, we utilize the `DECODE_CAN` node to decipher CAN bus messages received from a CAN bus sniffer (PEAK Can USB) and present the output in a tabular format.
