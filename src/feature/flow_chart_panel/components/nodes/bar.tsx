  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_5_181)">
        <path d="M10.4212 43.7522H0V58.9191H10.4212V43.7522Z" fill={accent} />
        <path d="M24.5665 0H14.1453V58.8693H24.5665V0Z" fill={accent} />
        <path
...
const BarChartTitle = ({ ...props }: SVGProps<SVGSVGElement>) => {
  const theme = useMantineTheme();
  const accent =
    theme.colorScheme === "dark"
      ? theme.colors.accent1[0]
