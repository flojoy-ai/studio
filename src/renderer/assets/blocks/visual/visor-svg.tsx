...
export const DefaultVisorSVG = (props: SVGProps<SVGSVGElement>) => (
...
const blockNameToSVGMap = {
  default: <DefaultVisorSVG width="100%" height="100%" />,
  // TODO: Uncomment if we want to show different svg for each visual blocks, or remove totally
  //   SCATTER: scatterSvg,
