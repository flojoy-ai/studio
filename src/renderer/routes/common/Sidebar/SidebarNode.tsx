...
import { DefaultDataBlock } from "@/renderer/assets/blocks/data-svg";
import { DefaultDSPBlock } from "@/renderer/assets/blocks/dsp-svg";
import { DefaultDebugBlock } from "@/renderer/assets/blocks/debugging-svg";
...
const iconMap: IconMap = {
  AI_ML: <DefaultAIBlock className="h-8 w-8" />,
  DATA: <DefaultDataBlock className="h-9 w-9" />,
  DSP: <DefaultDSPBlock className="h-8 w-8" />,
  ETL: <DefaultExtractBlock className="h-8 w-8" />,
  HARDWARE: <DefaultHardwareSVG className="h-7 w-7" />,
  NUMPY: <NumpySvg className="h-8 w-8" />,
  SCIPY: <ScipySvg className="h-8 w-8" />,
  DEBUGGING: <DefaultDebugBlock className="h-8 w-8" />,
