...
export const handleNodesLoadAtom = atom(
  null,
  (get, set, update: Node<ElementsData>[]) => {
    set(nodesAtom, update);
  }
);
export const handleEdgesLoadAtom = atom(null, (get, set, update: Edge[]) => {
  set(edgesAtom, update);
});
